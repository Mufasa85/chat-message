...
[ ] server/**tests**/auth.test.js existe et contient des tests Jest valides
[ ] server/**tests**/checkRole.test.js existe et contient des tests Jest valides  
[ ] server/**tests**/message.test.js existe et contient des tests Jest valides
