...
export default function MessageBubble({ msg, isOwn, onReply }) {
  ...
  const content = () => {
    ...
    if (msg.type === "video")
      return (
        <video src={att?.secureUrl || att?.url} controls style={s.video} />
      );
    if (msg.type === "audio")
      return (
        <div
    ...
    if (msg.type === "file")
      return (
        <a
          href={toDownloadUrl(att?.secureUrl || att?.url, att?.filename)}
        ...
        >
          ...
          <div>
            <p style={s.fname}>{att?.filename}</p>
            <p
              style={{
                color: "#9ca3af",
                fontSize: "0.75rem",
    ...
    if (msg.type === "system")
      return (
        <em style={{ color: "#9ca3af", fontSize: "0.85rem" }}>{msg.content}</em>
      );
  ...
  return (
    <div
      style={{ ...s.row, justifyContent: isOwn ? "flex-end" : "flex-start" }}
    >
      {!isOwn && (
        <div style={{ ...s.av, background: msg.author?.avatar || "#6366f1" }}>
      ...
      <div>
        ...
        <p style={{ ...s.time, textAlign: isOwn ? "right" : "left" }}>
          ...
          {msg.createdAt !== msg.updatedAt && (
            <span style={{ marginLeft: 4, fontStyle: "italic" }}></span>
          )}
        </p>
      </div>
      {isOwn && (
