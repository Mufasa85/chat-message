...
` +
          ...
          !n.hasOwnProperty(r) ||
            ...
            (r.indexOf(`--`) === 0
              ...
              : r === `float`
                ...
                : (e[r] = ``));
        for (var i in t)
          ((r = t[i]), t.hasOwnProperty(i) && n[i] !== r && nn(e, i, r));
    ...
    var kn = {
      ...
      Bn = On(
        h({}, kn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
      ),
      Vn = On(
        h({}, kn, {
      ...
      for (var i = t, a = !1; i !== null;) {
        ...
        if (i.tag === 10) {
          ...
          if (((o = o.memoizedProps), o !== null)) {
            var c = i.type;
            jr(i.pendingProps.value, o.value) ||
              (e === null ? (e = [c]) : e.push(c));
          }
          ...
          switch (a.$$typeof) {
            case _:
              a: {
                ...
                a.type === y
                  ? ((c = Si(a.props.children, e.mode, c, a.key)),
                    (c.return = e),
                    (e = c))
                  : ((c = xi(a.type, a.key, a.props, null, e.mode, c)),
                    Ha(c, a),
                    (c.return = e),
                    (e = c));
              }
        ...
        return (typeof a == `string` && a !== ``) ||
          ...
          ? ((a = `` + a),
            r !== null && r.tag === 6
              ...
              : (n(e, r), (c = Ci(a, e.mode, c)), (c.return = e), (e = c)),
            o(e))
          : n(e, r);
      }
    ...
    function Ho(e, t, n) {
      ...
      if (((a = e.baseState), i === null)) e.memoizedState = a;
        ...
        if (
          (l === null ? (o = a) : (l.next = c),
          !jr(a, e.memoizedState) && ((z = !0), d && ((n = ba), n !== null)))
        )
          throw n;
        ((e.memoizedState = a),
          (e.baseState = o),
    ...
    function Is(e, t, n) {
      ...
      ((n = {
        ...
        Bs(e)
          ? Vs(t, n)
          : ((n = di(e, t, n, r)), n !== null && (hu(n, e, r), Hs(n, t, r))));
    }
    function Ls(e, t, n) {
      Rs(e, t, n, pu());
    }
    ...
    function oc(e, t, n, r, i) {
      ...
      if (j)
        return (
          (t = uo.current),
          t === null
            ? (r !== Gi && ((t = Error(s(423), { cause: r })), Qi(Di(t, n))),
            ...
            : (!(t.flags & 65536) && (t.flags |= 256),
              (t.flags |= 65536),
              (t.lanes = i),
              r !== Gi && ((e = Error(s(422), { cause: r })), Qi(Di(e, n)))),
          !1
        );
    ...
    function _c(e, t, n) {
      ...
      if (a !== null) {
        ...
        if ((mo(t), i))
          ...
          (z || oa(e, t, n, !1), (i = (n & e.childLanes) !== 0), z || i)
        ) {
          if (
            ((r = G),
            r !== null && ((o = ut(r, n)), o !== 0 && o !== a.retryLane))
          )
            throw ((a.retryLane = o), fi(e, o), hu(r, e, o), sc);
          (Du(), (t = gc(e, t, n)));
        } else
          ((e = a.treeContext),
            (A = cf(o.nextSibling)),
    ...
    function Ec(e, t, n) {
      ...
      if (l !== null && ((c = l.dehydrated), c !== null)) {
        if (a)
          ...
          (z || oa(e, t, n, !1), (o = (n & e.childLanes) !== 0), z || o)
        ) {
          if (
            ((o = G),
            o !== null && ((r = ut(o, n)), r !== 0 && r !== l.retryLane))
          )
            throw ((l.retryLane = r), fi(e, r), hu(o, e, r), sc);
          (af(c) || Du(), (t = kc(e, t, n)));
        } else
          af(c)
      ...
      switch ((Bi(t), t.tag)) {
        ...
        case 27:
          if (
            ...
            ((e = he.current),
              Yi(t) ? qi(t, e) : ((e = ff(i, r, n)), (t.stateNode = e), Lc(t)));
          }
          return (B(t), null);
        case 5:
...
`,
  ...
  f = n(),
  p = u(),
  m = `http://10.173.193.120:3001/api`,
  ...
  g = ({ children: e }) => {
    let [t, n] = (0, f.useState)(() => {
      ...
      [r, i] = (0, f.useState)(() => localStorage.getItem(`token`)),
      a = (0, f.useCallback)(async (e, t) => {
        let r = await fetch(`${m}/auth/login`, {
            method: `POST`,
      ...
      o = (0, f.useCallback)(async (e, t) => {
        let r = await fetch(`${m}/auth/register`, {
            method: `POST`,
            headers: { "Content-Type": `application/json` },
            body: JSON.stringify({ username: e, password: t }),
          }),
      ...
      c = (0, f.useMemo)(
        () => ({ user: t, token: r, login: a, register: o, logout: s }),
        [t, r, a, o, s],
      );
    return (0, p.jsx)(h.Provider, { value: c, children: e });
  },
  _ = () => (0, f.useContext)(h),
  v = `ws://10.173.193.120:3001/ws`,
  y = ({ token: e, onMessage: t, onOpen: n, onClose: r }) => {
    ...
    return (
          ...
          n = () => {
            ...
            ((i.current = r),
              (r.onopen = () => {
                ...
                ((o.current = 0), c.current?.());
              }),
              (r.onmessage = (e) => {
                if (!t)
                  try {
                    s.current?.(JSON.parse(e.data));
                  } catch {
              ...
              (r.onclose = (e) => {
                if (t) return;
                if ((l.current?.(), e.code === 4001)) {
                  clearTimeout(a.current);
                  return;
                }
                if (o.current >= 15) {
                  console.log(`[WS] Limite de reconnexion atteinte:`, 15);
                  return;
                }
                let r = Math.min(1e3 * 2 ** o.current, 3e4);
                ((o.current += 1), (a.current = setTimeout(n, r)));
              }),
              (r.onerror = (e) => {
                t ||
                  (console.error(`[WS] Erreur:`, e),
                  console.error(`[WS] URL:`, r.url),
                  console.error(`[WS] ReadyState:`, r.readyState));
              }));
          };
        return (
          n(),
          () => {
            ((t = !0), clearTimeout(a.current));
            let e = i.current;
            e &&
              ((e.onopen = null),
              (e.onmessage = null),
      ...
      {
        emit: (0, f.useCallback)((e, t) => {
          i.current?.readyState === WebSocket.OPEN &&
            i.current.send(JSON.stringify({ event: e, data: t }));
        }, []),
      }
    );
  },
  ...
  x = ({ currentUser: e, emit: t }) => {
    let [n, r] = (0, f.useState)({
      ...
      s = (0, f.useCallback)(async (e) => {
        try {
          ...
          throw (console.error(`[WebRTC] Erreur accès média:`, e), e);
        }
      }, []),
      c = (0, f.useCallback)((e, t) => {
        let n = new RTCPeerConnection(b);
        return (
          (n.onicecandidate = (t) => {
          ...
          a.current &&
            a.current.getTracks().forEach((e) => {
              n.addTrack(e, a.current);
            }),
          (i.current = n),
          n
        );
        ...
        async (e, n) => {
          try {
            let i = await s(n),
              a = c(
                (n) => {
                  t(`ice_candidate`, { targetUserId: e, candidate: n });
                },
                (e) => {
                  r((t) => ({ ...t, remoteStream: e }));
                },
              ),
              o = await a.createOffer();
            return (
              await a.setLocalDescription(o),
              t(`call_offer`, {
                targetUserId: e,
                sdp: a.localDescription,
                callType: n,
              }),
              r({
                inCall: !0,
            ...
            return (console.error(`[WebRTC] Erreur startCall:`, e), !1);
          }
        },
        [t, s, c],
      ),
      u = (0, f.useCallback)(
        async ({
          ...
          try {
            ...
            await d.setRemoteDescription(new RTCSessionDescription(a));
            for (let e of o.current)
              await d.addIceCandidate(new RTCIceCandidate(e));
            o.current = [];
            let f = await d.createAnswer();
            (await d.setLocalDescription(f),
              t(`call_answer`, {
                targetUserId: e,
                sdp: d.localDescription,
                accepted: !0,
              }),
              r({
                inCall: !0,
                ...
                remoteStream: null,
                localStream: u,
                caller: { _id: e, username: n, avatar: i },
                targetUserId: e,
              }));
          } catch (e) {
            console.error(`[WebRTC] Erreur handleIncomingCall:`, e);
          }
        },
        [t, s, c],
      ),
      d = (0, f.useCallback)(async ({ sdp: e, accepted: t }) => {
        if (!t) {
          h();
          return;
        }
        try {
          if (i.current) {
            await i.current.setRemoteDescription(new RTCSessionDescription(e));
            for (let e of o.current)
              await i.current.addIceCandidate(new RTCIceCandidate(e));
            o.current = [];
          }
        } catch (e) {
          console.error(`[WebRTC] Erreur handleCallAnswer:`, e);
        }
      }, []),
      p = (0, f.useCallback)(async ({ candidate: e }) => {
        if (e)
          if (i.current?.remoteDescription)
            try {
              await i.current.addIceCandidate(new RTCIceCandidate(e));
            } catch (e) {
              console.error(`[WebRTC] Erreur addIceCandidate:`, e);
            }
          else o.current.push(e);
      }, []),
      m = (0, f.useCallback)(({ reason: e }) => {
        (console.log(`[WebRTC] Call ended:`, e), h());
      }, []),
      h = (0, f.useCallback)(() => {
        ((a.current &&= (a.current.getTracks().forEach((e) => e.stop()), null)),
          (i.current &&= (i.current.close(), null)),
          n.targetUserId &&
            t(`call_end`, { targetUserId: n.targetUserId, reason: `hangup` }),
          r({
            inCall: !1,
            callType: null,
            remoteStream: null,
    ...
    return {
      callState: n,
      startCall: l,
      handleIncomingCall: u,
      handleCallAnswer: d,
      handleIceCandidate: p,
      handleCallEnd: m,
      endCall: h,
    };
  },
  ee = `http://10.173.193.120:3001/api`,
  S = (0, f.createContext)(null),
  C = ({ children: e }) => {
    let { token: t, user: n } = _(),
      [r, i] = (0, f.useState)([]),
      ...
      [v, b] = (0, f.useState)(() => {
        try {
          let e = localStorage.getItem(`unreadCounts`);
      ...
      C = (0, f.useRef)(null),
      te = x({ currentUser: n, emit: (...e) => C.current?.(...e) }),
      ne = (0, f.useRef)(te);
    ne.current = te;
    let { emit: re } = y({
      token: t,
      onMessage: (0, f.useCallback)(
        ({ event: e, data: t }) => {
          switch (e) {
            case `new_message`:
              (c((e) => [...e, t]),
                t.room !== a?._id &&
                  b((e) => {
                    let n = { ...e, [t.room]: (e[t.room] || 0) + 1 };
                    return (
                      localStorage.setItem(`unreadCounts`, JSON.stringify(n)),
                      n
                    );
                  }));
              break;
            case `room_users`:
              ...
              break;
            case `user_left`:
              m((e) => e.filter((e) => e.userId !== t.userId));
              break;
            case `typing`:
              t.isTyping
                ? m((e) =>
                    e.find((e) => e.userId === t.userId)
                      ? e
                      : [...e, { userId: t.userId, username: t.username }],
                  )
                : m((e) => e.filter((e) => e.userId !== t.userId));
              break;
            case `message_uploaded`:
              ...
              break;
            case `incoming_call`:
              ne.current.handleIncomingCall(t);
              break;
            case `call_answer`:
              ne.current.handleCallAnswer(t);
              break;
            case `ice_candidate`:
              ne.current.handleIceCandidate(t);
              break;
            case `call_end`:
              ne.current.handleCallEnd(t);
              break;
          }
        },
        [a, n],
      ),
      onOpen: (0, f.useCallback)(() => {
        (console.log(`[WS] Connecté`), g(!0));
      }, []),
      onClose: (0, f.useCallback)(() => {
        (console.log(`[WS] Déconnecté`), g(!1));
      }, []),
    });
    C.current = re;
    let w = (0, f.useCallback)(async () => {
        i(
          await (
            await fetch(`${ee}/rooms`, {
      ...
      ie = (0, f.useCallback)(
        async (e) => {
          (b((t) => {
            let n = { ...t, [e._id]: 0 };
            return (localStorage.setItem(`unreadCounts`, JSON.stringify(n)), n);
          }),
            o(e),
            c([]),
            u([]),
            ...
            c(
              await (
                await fetch(`${ee}/rooms/${e._id}/messages`, {
                  headers: { Authorization: `Bearer ${t}` },
                })
              ).json(),
            ),
            C.current(`join_room`, { roomId: e._id }));
        },
        [t],
      ),
      ae = (0, f.useCallback)(
      ...
      se = (0, f.useCallback)(
        (e) => {
          a && C.current(`typing`, { roomId: a._id, isTyping: e });
        },
        [a],
      ),
      ce = (0, f.useCallback)((e) => {
        c((t) => (t.some((t) => t._id === e._id) ? t : [...t, e]));
      }, []),
      le = (0, f.useCallback)(
        async (e, n = ``) => {
          let r = await fetch(`${ee}/rooms`, {
            method: `POST`,
            headers: {
              Authorization: `Bearer ${t}`,
              "Content-Type": `application/json`,
            },
            body: JSON.stringify({ name: e, description: n }),
          });
      ...
      T = (0, f.useCallback)(
        () => Object.values(v).reduce((e, t) => e + t, 0),
        [v],
      ),
      E = (0, f.useMemo)(
        () => ({
        ...
        [r, a, s, l, d, h, v, w, ie, ae, oe, se, le, ce, ue, T, te],
      );
    return (0, p.jsx)(S.Provider, { value: E, children: e });
  },
  te = () => (0, f.useContext)(S);
function ne() {
  let { login: e, register: t } = _(),
    [n, r] = (0, f.useState)(!0),
    [i, a] = (0, f.useState)(``),
    [o, s] = (0, f.useState)(``),
    [c, l] = (0, f.useState)(``),
    ...
    [g, v] = (0, f.useState)(!1),
    y = async (r) => {
      if ((r.preventDefault(), d(``), !n && o !== c)) {
        d(`Les mots de passe ne correspondent pas`);
        return;
      }
      if (i.length < 2) {
        d(`Le nom d'utilisateur doit contenir au moins 2 caractères`);
        return;
      }
      if (o.length < 6) {
    ...
    b = async () => {
      (a(`guest`), s(`guest123`), h(!0));
      try {
        await e(`guest`, `guest123`);
      } catch {
        d(`Compte invité non disponible`);
      } finally {
        h(!1);
      }
    };
  return (0, p.jsxs)(`div`, {
    className: `min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-950 via-purple-950 to-slate-950 relative overflow-hidden`,
    children: [
      (0, p.jsxs)(`div`, {
        className: `absolute inset-0 overflow-hidden`,
        children: [
          (0, p.jsx)(`div`, {
            className: `absolute top-1/4 left-1/4 w-96 h-96 bg-indigo-500/20 rounded-full blur-3xl animate-pulse`,
          }),
          (0, p.jsx)(`div`, {
            className: `absolute bottom-1/4 right-1/4 w-96 h-96 bg-purple-500/20 rounded-full blur-3xl animate-pulse delay-1000`,
          }),
          (0, p.jsx)(`div`, {
            className: `absolute top-1/2 right-1/3 w-64 h-64 bg-pink-500/10 rounded-full blur-3xl animate-pulse delay-500`,
          }),
        ],
      }),
      (0, p.jsx)(`div`, {
      ...
      (0, p.jsxs)(`div`, {
        ...
        children: [
          (0, p.jsxs)(`div`, {
            className: `bg-slate-900/80 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-slate-700/50`,
            children: [
              (0, p.jsxs)(`div`, {
                className: `text-center mb-8`,
                children: [
                  (0, p.jsx)(`div`, {
                    className: `inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl mb-4 shadow-lg shadow-indigo-500/25`,
              ...
              (0, p.jsxs)(`form`, {
                ...
                children: [
                  ...
                  u &&
                    (0, p.jsxs)(`div`, {
                      className: `flex items-center gap-2 p-3 bg-red-500/10 border border-red-500/20 rounded-xl animate-shake`,
                      children: [
                        (0, p.jsx)(`svg`, {
                    ...
                    children: m
                      ? (0, p.jsxs)(p.Fragment, {
                          children: [
                            ...
                            (0, p.jsx)(`span`, { children: `Chargement...` }),
                          ],
                        })
                      : (0, p.jsx)(`span`, {
                          children: n ? `Se connecter` : `Créer un compte`,
                        }),
                  }),
                ],
              }),
                ...
                children: [
                  ...
                  (0, p.jsx)(`div`, {
                    ...
                    children: (0, p.jsx)(`span`, {
                      className: `px-4 bg-slate-900 text-slate-500`,
                      children: `ou`,
                    }),
                  }),
                ],
              ...
              (0, p.jsxs)(`button`, {
                ...
                children: [
                  ...
                  (0, p.jsx)(`span`, {
                    children: `Continuer en tant qu'invité`,
                  }),
                ],
              }),
              (0, p.jsx)(`div`, {
          ...
          (0, p.jsx)(`p`, {
            ...
            children: `En continuant, vous acceptez nos conditions d'utilisation`,
          }),
        ],
      }),
      (0, p.jsx)(`style`, {
...
var re = `http://10.173.193.120:3001/api`,
  w = ({ token: e, onUploaded: t, onMessageUploaded: n }) => {
    let [r, i] = (0, f.useState)(!1),
      ...
      d = async (r, a) => {
        if (!(!r || !a)) {
          ...
          try {
            let i = new FormData();
            (i.append(`file`, r), i.append(`roomId`, a));
            let s = await new Promise((t, n) => {
              ...
              ((r.upload.onprogress = (e) => {
                ...
                (r.onload = () =>
                  r.status < 300
                    ...
                    : n(Error(JSON.parse(r.responseText).error))),
                (r.onerror = () => n(Error(`Erreur réseau`))),
                r.open(`POST`, `${re}/upload`),
                r.setRequestHeader(`Authorization`, `Bearer ${e}`),
                r.send(i));
            });
            (t?.(s), n?.(s));
          } catch (e) {
            ...
            (i(!1), o(0), l.current && (l.current.value = ``));
          }
        }
      };
    return {
      ...
      FileInput: ({ roomId: e, disabled: t }) =>
        (0, p.jsxs)(`button`, {
          ...
          children: [
            (0, p.jsx)(`span`, { className: `text-lg`, children: `📎` }),
            (0, p.jsx)(`input`, {
              ref: l,
              type: `file`,
              style: { display: `none` },
  ...
  ie = `http://10.173.193.120:3001/api`;
function ae({ token: e, onSelect: t, onClose: n }) {
  let [r, i] = (0, f.useState)(``),
    ...
    g = (0, f.useCallback)(
      async (t, n = 0, r = !1) => {
        c(!0);
        try {
          let i = new URLSearchParams({ limit: 24, offset: n });
          t && i.set(`q`, t);
          let a = await (
            await fetch(`${ie}/upload/giphy?${i}`, {
              headers: { Authorization: `Bearer ${e}` },
            })
          ).json();
          (o((e) => (r ? [...e, ...a.gifs] : a.gifs)), m(a.gifs.length === 24));
        } catch (e) {
          ...
          children: [
            ...
            s &&
              Array.from({ length: 8 }).map((e, t) =>
                (0, p.jsx)(`div`, { style: _.skeleton }, t),
              ),
          ],
        }),
        d &&
...
function ce({ msg: e, isOwn: t }) {
  let n = e.attachment,
    ...
    i = [`giphy`, `image`, `video`].includes(e.type),
    a = () =>
      e.type === `giphy` || e.type === `image`
        ? (0, p.jsxs)(`div`, {
            children: [
              (0, p.jsx)(`a`, {
                href: n?.secureUrl || n?.url,
                target: `_blank`,
                rel: `noreferrer`,
                children: (0, p.jsx)(`img`, {
                  src: n?.secureUrl || n?.url,
                  alt: n?.giphyTitle || n?.filename || `media`,
                  style: r.img,
                  loading: `lazy`,
                }),
              }),
              e.content &&
                (0, p.jsx)(`p`, { style: r.cap, children: e.content }),
            ],
          })
        : e.type === `video`
          ? (0, p.jsx)(`video`, {
          ...
          : e.type === `audio`
            ...
            : e.type === `file`
              ...
              : e.type === `system`
                ...
                : (0, p.jsx)(`span`, { children: e.content });
  return (0, p.jsxs)(`div`, {
    style: { ...r.row, justifyContent: t ? `flex-end` : `flex-start` },
    children: [
      !t &&
        (0, p.jsx)(`div`, {
          style: { ...r.av, background: e.author?.avatar || `#6366f1` },
          children: e.author?.username?.[0]?.toUpperCase(),
        }),
      (0, p.jsxs)(`div`, {
        children: [
          !t &&
          ...
          (0, p.jsx)(`p`, {
            style: { ...r.time, textAlign: t ? `right` : `left` },
            children: new Date(e.createdAt).toLocaleTimeString(`fr-FR`, {
              hour: `2-digit`,
              minute: `2-digit`,
            }),
          }),
    ...
    let r = () => {
      try {
        ...
        (n.connect(r),
          ...
          r.gain.setValueAtTime(0.1, e.currentTime),
          r.gain.exponentialRampToValueAtTime(0.001, e.currentTime + 0.6),
          n.start(),
          n.stop(e.currentTime + 0.6));
      } catch {}
    };
    return (
      r(),
      (n.current = setInterval(r, 2e3)),
      () => {
        (clearInterval(n.current), t.current?.close());
      }
    );
  }, [e]);
}
function ue({
  ...
  if ((le(e === `incoming`), !e || e === `idle`)) return null;
  let m = (e, t, n = 56) =>
    (0, p.jsx)(`div`, {
      style: {
        width: n,
  ...
  return e === `calling` || (e === `active` && t === `audio`)
    ? (0, p.jsx)(`div`, {
        style: E.overlay,
        children: (0, p.jsxs)(`div`, {
          style: E.card,
          children: [
            (0, p.jsx)(`p`, {
              style: E.subtitle,
              children:
                e === `calling` ? `Appel en cours...` : `🎙 Appel audio actif`,
            }),
            m(n?.username, n?.avatar, 80),
            (0, p.jsx)(`p`, { style: E.name, children: n?.username }),
            (0, p.jsxs)(`div`, {
              style: E.controls,
              children: [
                (0, p.jsx)(T, {
                  icon: i ? `🔇` : `🎙`,
                  label: i ? `Activer` : `Couper`,
                  onClick: d,
                  active: i,
                }),
                (0, p.jsx)(T, {
      ...
      : e === `active` && t === `video`
        ? (0, p.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, p.jsx)(`div`, { style: E.remoteName, children: n?.username }),
              (0, p.jsxs)(`div`, {
                style: E.videoControls,
                children: [
                  (0, p.jsx)(T, {
                    icon: i ? `🔇` : `🎙`,
                    label: i ? `Micro off` : `Micro`,
                    onClick: d,
                    active: i,
                    small: !0,
                  }),
...
function T({
  ...
  return (0, p.jsxs)(`button`, {
    ...
    style: {
      ...
      alignItems: `center`,
      gap: 4,
      background: r ? `#ef4444` : i ? `#22c55e` : a ? `#374151` : `#2d2d4e`,
      border: `none`,
      borderRadius: 14,
      padding: o ? `8px 14px` : `12px 20px`,
      color: `#fff`,
      cursor: `pointer`,
      transition: `opacity .15s`,
      fontSize: o ? `1.3rem` : `1.6rem`,
      minWidth: o ? 72 : 90,
    },
    children: [
    ...
    ? (0, p.jsxs)(`div`, {
        ...
        children: [
          (0, p.jsx)(`button`, {
            style: fe.btn,
            onClick: () => t(e, `audio`),
            title: `Appel audio avec ${e.username}`,
            children: `🎙`,
          }),
          (0, p.jsx)(`button`, {
            style: fe.btn,
            onClick: () => t(e, `video`),
            title: `Appel vidéo avec ${e.username}`,
            children: `📹`,
          }),
        ],
      })
...
var fe = {
  ...
  pe = `10,30,60,120,300`.split(`,`).map(Number) || [10, 30, 60, 120, 300],
  me = `10 sec,30 sec,1 min,2 min,5 min`.split(`,`) || [
    `10 sec`,
    `30 sec`,
    `1 min`,
    `2 min`,
  ...
  D = pe.map((e, t) => ({ value: e, label: me[t] || `${e}s` }));
function O({ token: e }) {
  let {
      sendMessage: t,
      sendTyping: n,
  ...
  return (0, p.jsxs)(`div`, {
    ...
    children: [
      v &&
        (0, p.jsx)(`div`, {
          className: `absolute top-0 left-0 right-0 h-1 bg-slate-700/50`,
          children: (0, p.jsx)(`div`, {
      ...
      (0, p.jsxs)(`div`, {
        className: `flex items-end gap-3 bg-slate-800/50 rounded-2xl border border-slate-700/50 px-4 py-3`,
        children: [
          (0, p.jsxs)(`div`, {
            className: `relative`,
            ref: _,
            children: [
              (0, p.jsx)(`button`, {
                onClick: () => d(!u),
                disabled: !i || v,
                className: `p-2 rounded-lg transition-all disabled:opacity-40 disabled:cursor-not-allowed ${c === null ? `text-gray-500 hover:text-gray-300 hover:bg-slate-700/50` : `bg-indigo-600 text-white`}`,
              ...
              u &&
                (0, p.jsxs)(`div`, {
                  className: `absolute bottom-full left-0 mb-2 bg-[#313338] rounded-lg shadow-xl border border-black/30 py-2 min-w-[120px]`,
                  children: [
                    (0, p.jsx)(`div`, {
                      className: `px-3 py-1 text-gray-400 text-xs uppercase tracking-wider`,
                      children: `Durée`,
                    }),
                    D.map((e) =>
                      (0, p.jsx)(
                        ...
                        {
                          onClick: () => S(e.value),
                          className: `w-full px-3 py-1.5 text-left text-sm hover:bg-[#404249] transition-colors ${c === e.value ? `text-indigo-400` : `text-gray-300`}`,
                          children: e.label,
                        },
                        e.value,
                      ),
          ...
          (0, p.jsx)(b, { roomId: i?._id, disabled: !i || v }),
          (0, p.jsx)(`button`, {
            onClick: () => h(!m),
            disabled: !i || v,
            className: `text-gray-500 hover:text-gray-300 disabled:opacity-40 disabled:cursor-not-allowed p-2 rounded-lg hover:bg-slate-700/50 transition-all`,
          ...
          (0, p.jsx)(`textarea`, {
            ...
            placeholder: i
              ? `Envoyer un message dans ${i.name}`
              : `Rejoins un salon pour discuter...`,
            value: o,
            onChange: x,
            onKeyDown: (e) => {
...
function he({ room: e, isActive: t, onClick: n, unreadCount: r }) {
  let i = r > 0;
  return (0, p.jsxs)(`div`, {
    onClick: n,
    className: `flex items-center gap-2 px-2 py-1.5 rounded-md cursor-pointer transition-colors group relative ${t ? `bg-[#404249] text-white` : i ? `text-white font-semibold bg-[#35363c]/70` : `text-gray-400 hover:bg-[#35373c] hover:text-white`}`,
    children: [
      i &&
        (0, p.jsx)(`div`, {
      ...
      t
        ...
        : (0, p.jsx)(`svg`, {
            className: `w-4 h-4 flex-shrink-0 ${i ? `text-gray-300` : ``}`,
            fill: `none`,
            stroke: `currentColor`,
            viewBox: `0 0 24 24`,
            children: (0, p.jsx)(`path`, {
      ...
      (0, p.jsx)(`span`, {
        className: `text-sm truncate flex-1 ${i ? `font-medium` : ``}`,
        children: e.name,
      }),
      i &&
        (0, p.jsx)(`span`, {
          className: `
          flex items-center justify-center min-w-[22px] h-6 px-1.5 rounded-full text-xs font-bold shadow-lg
          ${r >= 10 ? `bg-red-500 text-white` : r >= 5 ? `bg-orange-500 text-white` : `bg-indigo-500 text-white`}
        `,
          children: r > 99 ? `99+` : r,
        }),
    ],
...
function ge() {
  ...
  let oe = async () => {
    ...
    se = h();
  return (0, p.jsxs)(`div`, {
    className: `flex h-dvh bg-[#1a1a1a]`,
    children: [
      ne &&
        (0, p.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, p.jsxs)(`div`, {
              className: `w-64 bg-[#1e1f22] flex flex-col h-full`,
              children: [
                (0, p.jsxs)(`div`, {
                  className: `p-4 border-b border-black/30 flex items-center justify-between`,
                  children: [
                    (0, p.jsx)(`h2`, {
                      ...
                      children: [
                        s.map((e) =>
                          (0, p.jsx)(
                            ...
                            {
                              room: e,
                              isActive: i?._id === e._id,
                              onClick: () => {
                                (c(e), re(!1));
                              },
                              unreadCount: m[e._id] || 0,
                            },
                            e._id,
                          ),
                        ),
                        s.length === 0 &&
                          (0, p.jsx)(`p`, {
                            className: `text-gray-500 text-xs px-2 py-4 text-center`,
                ...
                (0, p.jsx)(`div`, {
                  className: `bg-[#232428] p-2`,
                  children: (0, p.jsxs)(`div`, {
                    className: `flex items-center gap-2 px-2 py-1.5 rounded bg-[#35363c]`,
                    children: [
                      (0, p.jsx)(`div`, {
                        className: `w-8 h-8 rounded-full flex items-center justify-center text-white text-xs font-semibold`,
                        style: { background: e?.avatar || `#6366f1` },
                        children: e?.username?.[0]?.toUpperCase(),
                      }),
                      (0, p.jsxs)(`div`, {
      ...
      (0, p.jsxs)(`div`, {
        className: `hidden md:flex w-16 bg-[#1a1a1a] flex flex-col items-center py-3 gap-2 border-r border-black/30`,
        children: [
          (0, p.jsxs)(`button`, {
            onClick: () => re(!0),
            ...
            children: [
              ...
              se > 0 &&
                (0, p.jsx)(`span`, {
                  className: `absolute -top-1 -right-1 flex items-center justify-center min-w-[18px] h-[18px] px-1 rounded-full bg-red-500 text-white text-[10px] font-bold`,
                  children: se > 99 ? `99+` : se,
                }),
            ],
          }),
          (0, p.jsx)(`div`, {
            className: `w-8 h-0.5 bg-[#313338] rounded-full my-1`,
          }),
          (0, p.jsx)(`button`, {
            onClick: () => {
              v(!0);
      ...
      (0, p.jsxs)(`div`, {
        className: `hidden md:flex w-60 bg-[#1e1f22] flex-col`,
        children: [
          (0, p.jsx)(`div`, {
            className: `p-4 border-b border-black/30`,
            children: (0, p.jsxs)(`div`, {
              className: `flex items-center justify-between`,
              children: [
                (0, p.jsx)(`h2`, {
                  className: `text-white font-semibold`,
                  children: `Serveur Discord-like`,
                }),
                (0, p.jsx)(`button`, {
                  className: `text-gray-400 hover:text-white`,
                  children: (0, p.jsx)(`svg`, {
      ...
      (0, p.jsxs)(`div`, {
        className: `flex-1 flex flex-col bg-[#2b2d31]`,
        children: [
          (0, p.jsxs)(`div`, {
            className: `h-14 px-4 flex items-center gap-2 border-b border-black/30 shadow-sm bg-[#313338]`,
            children: [
              (0, p.jsx)(`button`, {
                onClick: () => re(!ne),
              ...
              (0, p.jsx)(`span`, {
                ...
                children: i ? ` ${i.name}` : `Bienvenue`,
              }),
              i &&
                (0, p.jsxs)(p.Fragment, {
                  children: [
                    (0, p.jsx)(`div`, {
                      className: `w-px h-4 bg-gray-600 mx-2`,
                    }),
                    (0, p.jsx)(`span`, {
                      className: `text-gray-400 text-sm hidden sm:inline`,
                      children: i.description || `Aucun sujet`,
                    }),
                  ],
                }),
              (0, p.jsxs)(`div`, {
            ...
            children: [
              i
                      ...
                      r.map((t) =>
                        (0, p.jsx)(
                          ce,
                          {
                            msg: t,
                            isOwn:
                              t.author?._id === e?._id || t.author === e?._id,
                          },
                          t._id,
                        ),
                      ),
                      o.length > 0 &&
                        (0, p.jsxs)(`div`, {
                          ...
                          children: [
                            ...
                            (0, p.jsxs)(`span`, {
                              children: [
                                o.map((e) => e.username).join(`, `),
                                ` `,
                                o.length === 1 ? `tape` : `tapent`,
                                `...`,
                              ],
                            }),
                          ],
                ...
                : (0, p.jsxs)(`div`, {
                    ...
                    children: [
                      (0, p.jsx)(`div`, {
                        className: `w-20 h-20 rounded-full bg-[#313338] flex items-center justify-center mb-6`,
                        children: (0, p.jsx)(`svg`, {
                      ...
                      (0, p.jsx)(`h2`, {
                        ...
                        children: `Bienvenue dans le serveur`,
                      }),
                      (0, p.jsx)(`p`, {
                        className: `text-gray-400 text-center max-w-md`,
                        children: `Sélectionnez un salon textuel dans la liste des canaux pour commencer à discuter`,
                      }),
                    ],
                  }),
              (0, p.jsx)(`div`, { ref: ae }),
          ...
          (0, p.jsx)(O, { token: t }),
          (0, p.jsxs)(`div`, {
            className: `md:hidden h-10 px-4 flex items-center justify-between bg-[#232428] border-t border-black/30`,
            children: [
              (0, p.jsxs)(`div`, {
      ...
      i &&
        S &&
        (0, p.jsx)(`div`, {
          className: `hidden lg:flex w-60 bg-[#1e1f22] border-l border-black/30`,
          children: (0, p.jsxs)(`div`, {
            className: `p-4`,
            children: [
              (0, p.jsxs)(`h3`, {
                className: `text-gray-400 text-xs font-semibold uppercase tracking-wider mb-4`,
                children: [`En ligne — `, a.length],
              }),
              (0, p.jsx)(`div`, {
                className: `space-y-1`,
                children: a.map((t) => {
                  let n = String(t._id) === String(e?._id);
                  return (0, p.jsxs)(
                    `div`,
                    {
                      ...
                      children: [
                        (0, p.jsxs)(`div`, {
                          ...
                          children: [
                            (0, p.jsx)(`div`, {
                              className: `w-8 h-8 rounded-full flex items-center justify-center text-white text-xs font-semibold`,
                              style: { background: t.avatar || `#6366f1` },
                              children: t.username?.[0]?.toUpperCase(),
                            }),
                            (0, p.jsx)(`div`, {
                              className: `absolute -bottom-0.5 -right-0.5 w-3 h-3 bg-green-500 rounded-full border-2 border-[#1e1f22]`,
                            }),
                          ],
                        }),
                        (0, p.jsx)(`span`, {
      ...
      g &&
        (0, p.jsx)(`div`, {
          ...
          children: (0, p.jsxs)(`div`, {
            ...
            children: [
              (0, p.jsxs)(`div`, {
                className: `p-4 border-b border-black/20`,
                children: [
                  (0, p.jsx)(`h3`, {
                    className: `text-white text-lg font-semibold`,
                    children: `Créer un salon`,
                  }),
                  (0, p.jsx)(`p`, {
                    className: `text-gray-400 text-sm mt-1`,
                    children: `Les salons textuels permettent d'envoyer des messages`,
                  }),
                ],
              }),
              (0, p.jsxs)(`div`, {
                ...
                children: [
                  (0, p.jsxs)(`div`, {
                    children: [
                      (0, p.jsx)(`label`, {
                        className: `text-gray-300 text-xs font-semibold uppercase tracking-wider block mb-2`,
                      ...
                      (0, p.jsx)(`input`, {
                        ...
                        value: y,
                        onChange: (e) =>
                          b(e.target.value.toLowerCase().replace(/\s+/g, `-`)),
              ...
              (0, p.jsxs)(`div`, {
                className: `flex justify-end gap-3 p-4 border-t border-black/20`,
                children: [
                  (0, p.jsx)(`button`, {
                    onClick: () => v(!1),
      ...
      w &&
        (0, p.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, p.jsxs)(`div`, {
              className: `w-72 bg-[#1e1f22] flex flex-col h-full max-w-[85vw]`,
              children: [
                (0, p.jsxs)(`div`, {
                  className: `p-4 border-b border-black/30 flex items-center justify-between`,
                  children: [
                  ...
                  children: [
                    ...
                    (0, p.jsxs)(`div`, {
                      ...
                      children: [
                                ...
                                (0, p.jsxs)(`div`, {
                                  ...
                                  children: [
                                    (0, p.jsx)(`div`, {
                                      ...
                                      style: {
                                        background: t.avatar || `#6366f1`,
                                      },
                                      children: t.username?.[0]?.toUpperCase(),
                                    }),
                                    (0, p.jsx)(`div`, {
                                      className: `absolute -bottom-0.5 -right-0.5 w-3.5 h-3.5 bg-green-500 rounded-full border-2 border-[#1e1f22]`,
                                    }),
                                  ],
                                }),
                                (0, p.jsxs)(`div`, {
                        ...
                        a.length === 0 &&
                          (0, p.jsx)(`p`, {
                            className: `text-gray-500 text-sm px-2 py-4 text-center`,
                            children: `Aucun utilisateur en ligne`,
                          }),
                      ],
                    }),
                  ],
      ...
      (0, p.jsx)(ue, {
        ...
        isMuted: d.isMuted,
        isCamOff: d.isCamOff,
        localVideoRef: d.localVideoRef,
        remoteVideoRef: d.remoteVideoRef,
        onAccept: d.acceptCall,
        onReject: d.rejectCall,
        onHangUp: d.hangUp,
        onToggleMute: d.toggleMute,
        onToggleCamera: d.toggleCamera,
      }),
    ],
  });
}
function _e() {
  let { token: e } = _();
  return e
    ? (0, p.jsx)(C, { children: (0, p.jsx)(ge, {}) })
    : (0, p.jsx)(ne, {});
}
function ve() {
  return (0, p.jsx)(g, { children: (0, p.jsx)(_e, {}) });
}
(0, d.createRoot)(document.getElementById(`root`)).render(
  (0, p.jsx)(f.StrictMode, { children: (0, p.jsx)(ve, {}) }),
);
