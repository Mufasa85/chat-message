...
const S = {
  ...
  panel:   { background:'#111827', width:'100%', maxWidth:1100, borderRadius:'20px 20px 0 0', display:'flex', flexDirection:'column', height:'90vh', overflow:'hidden', boxShadow:'0 -8px 40px rgba(0,0,0,0.7)', border:'1px solid rgba(255,255,255,0.07)' },
