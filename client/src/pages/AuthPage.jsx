  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-950 via-purple-950 to-slate-950 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        <div className="bg-slate-900/80 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-slate-700/50">
          {/* Logo and Title */}
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {!isLogin && (
              <div className="space-y-2 animate-fade-in">
                <label className="text-sm font-medium text-slate-300 block">Confirmer le mot de passe</label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <svg className="w-5 h-5 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="mt-6 text-center">
            ...
            >
              {isLogin ? (
                <>
                  Pas de compte ?{' '}
                  <span className="text-indigo-400 hover:text-indigo-300 font-medium">S'inscrire</span>
                </>
              ) : (
                <>
                  Déjà un compte ?{' '}
                  <span className="text-indigo-400 hover:text-indigo-300 font-medium">Se connecter</span>
                </>
              )}
            </button>
          </div>
