...
const IcOnline = () => (
  ...
  >
    ...
    <path d="M8 12l3 3 5-5" stroke="#10b981" />
  </svg>
);
const IcMsg = () => (
  <svg
            ...
            <>
                      ...
                      {STATUS_OPTIONS.map((opt) => (
                        <button
                          ...
                          style={{
                            ...
                            gap: 5,
                            padding: "5px 10px",
                            border: `2px solid ${status === opt.value ? opt.color : "transparent"}`,
                            borderRadius: 7,
                            background:
                              status === opt.value
                                ? opt.color + "22"
              ...
              <button onClick={saveProfile} disabled={saving} style={s.btn()}>
                {saving ? (
                  ...
                  >
                    <IcSave /> Sauvegarder les modifications
                  </span>
                )}
              </button>
              {profileMsg && (
                <div style={s.msg(profileMsg.type)}>{profileMsg.text}</div>
              )}
            </>
          )}
                ...
                {statsLoading ? (
                  ...
                  <div style={s.statsGrid}>
                    ...
                    <StatCard
                      ...
                      value={stats.totalUsers - stats.adminCount}
                      color="#14b8a6"
                    />
                  </div>
                ) : (
